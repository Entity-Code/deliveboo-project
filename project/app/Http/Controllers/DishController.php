...
class DishController extends Controller
{
    ...
    public function create() {
        ...
        return view('pages.dish-create', compact('dishes', 'dishs', 'categories'));
    }
    ...
    public function edit($id) {
        ...
        return view('pages.dish-edit', compact('dishs','categories','dish'));
    }
